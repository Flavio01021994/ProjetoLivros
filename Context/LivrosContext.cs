...
namespace ProjetoLivros.Context
{
    public class LivrosContext : DbContext
    {
        ...
        {
            // String de Coneccao 
            optionsBuilder.UseSqlServer("Data Source=NOTE16-S28\\SQLEXPRESS;Initial Catalog=Livros;User Id=sa;Password=Senai@134;TrustServerCertificate=true;");
        }
